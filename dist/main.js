(() => {
  ...
  var require_bufferbuilder = __commonJS((exports, module) => {
    var binaryFeatures = {};
  ...
  var require_rtcpeerconnection = __commonJS((exports, module) => {
    ...
    module.exports = function(window2, edgeVersion) {
      ...
      RTCPeerConnection2.prototype._transceive = function(transceiver, send, recv) {
        var params2 = getCommonCapabilities(transceiver.localCapabilities, transceiver.remoteCapabilities);
        ...
        if (description.type === "offer") {
          ...
          sections.forEach(function(mediaSection, sdpMLineIndex) {
            ...
            if (!rejected && !transceiver.rejected) {
              ...
              var params2 = getCommonCapabilities(localCapabilities, remoteCapabilities);
              pc._transceive(transceiver, params2.codecs.length > 0, false);
            }
          });
        }
  ...
  var import_peerjs_js_binarypack = __toModule(require_binarypack());
      ...
      window2.RTCPeerConnection.prototype.addTransceiver = function addTransceiver() {
        ...
        if (shouldPerformCheck) {
          ...
          if (!("encodings" in params2) || params2.encodings.length === 1 && Object.keys(params2.encodings[0]).length === 0) {
            ...
            this.setParametersPromises.push(sender.setParameters(params2).then(() => {
  ...
  var shareButton = document.getElementById("share-copy");
  peer.on("open", (id) => {
    console.debug(`My peer ID is ${id}`);
    const share = document.getElementById("share-id");
    const shareHidden = document.getElementById("share-id-hidden");
    share.innerText = id;
    shareHidden.innerText = id;
